# FIRST YEAR HOMESCHOOLING TRANSFERS

# THIS SCRIPT ALWAYS: first-year homeschool transfers v. all public 

# Question: Are first-year homeschool transfers similar to or different from 
# children who remain in public school? 
...
# RACE/ETHNICITY
svymean(~RACEETH == 1, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1))
svymean(~RACEETH == 1, subset(PFIdesign, SCHTYPE == 1))

svymean(~RACEETH == 2, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1))
svymean(~RACEETH == 2, subset(PFIdesign, SCHTYPE == 1))

svymean(~RACEETH == 3, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1))
svymean(~RACEETH == 3, subset(PFIdesign, SCHTYPE == 1))

svymean(~RACEETH == 1, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))
svymean(~RACEETH == 2, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))
svymean(~RACEETH == 3, subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))

# -----

# COLLEGE DEGREE
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1))
svymean(~(ba_no_ba == 1), subset(PFIdesign, SCHTYPE == 1))

# college degree, white children only
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 1))
svymean(~(ba_no_ba == 1), subset(PFIdesign, SCHTYPE == 1 & RACEETH == 1))

# college degree, Black children only
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 2))
...
# White children, homeschool only, grades K-6 v 7-12:
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 1 & 
                                   elementary_secondary == 1))
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 1 & 
                                   elementary_secondary == 2))

# Black children, homeschool only, grades K-6 v 7-12:
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 2 & 
                                   elementary_secondary == 1))
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 2 & 
                                   elementary_secondary == 2))

# Hispanic children, homeschool only, grades K-6 v 7-12:
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 3 & 
                                   elementary_secondary == 1))
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 3 & 
                                   elementary_secondary == 2))
...
# POVERTY LEVEL
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1))
svymean(~(poverty == 1), subset(PFIdesign, SCHTYPE == 1))

# poverty level, white only
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 1))
svymean(~(poverty == 1), subset(PFIdesign, SCHTYPE == 1 & RACEETH == 1))

# poverty level, Black only
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 2))
svymean(~(poverty == 1), subset(PFIdesign, SCHTYPE == 1 & RACEETH == 2))

# poverty level, Hispanic only
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 3))
...
# at or near poverty, white only
svymean(~(SES < 3), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 1))
svymean(~(SES < 3), subset(PFIdesign, SCHTYPE == 1 & RACEETH == 1))

# at or near poverty, Black only
svymean(~(SES < 3), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 2))
svymean(~(SES < 3), subset(PFIdesign, SCHTYPE == 1 & RACEETH == 2))

# at or near poverty, Hispanic only
svymean(~(SES < 3), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & RACEETH == 3))
...
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 1))
svymean(~(ba_no_ba == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))
...
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 1))
svymean(~(poverty == 1), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))
...
svymean(~(poverty < 3), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 1))
svymean(~(poverty < 3), subset(HOMEdesign, FIRST == 1 & ALWAYS != 1 & elementary_secondary == 2))
