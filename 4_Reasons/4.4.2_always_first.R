...
# Always homeschoolers v. First-year homeschoolers

# Create subsets to enable comparison 

HS_A <- subset(HOME, SCHTYPE == 3 & ALWAYS == 1)
HS_F <- subset(HOME, SCHTYPE == 3 & FIRST == 1)
...
# Always v. first year homeschooled students
...
svymean(~(HSMOSTX == 5 | HSMOSTX == 6 | HSMOSTX == 7), subset(HOMEdesign, FIRST == 1), na.rm=T)
